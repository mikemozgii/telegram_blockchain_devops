 ...
 (function () {
  ...
  (function (root, factory) {
   ...
   function watchScroll(viewAreaElement, callback) {
    ...
    var state = {
     down: true,
     lastY: viewAreaElement !== null ? viewAreaElement.scrollTop : 0,
  ...
  (function (root, factory) {
   ...
   function configure(PDFJS) {
    ...
    PDFJS.workerSrc = '/libs/pdfjs/dist/pdf.worker.js';
   ...
   var PDFViewerApplication = {
    ...
    bindWindowEvents: function pdfViewBindWindowEvents() {
     ...
     window.addEventListener('change', function windowChange(evt) {
       //need to avoid conflicting with our file input
      return;
...
function webViewerLoad() {
 ...
 //document.PDFViewerApplication = pdfjsWebLibs.pdfjsWebApp.PDFViewerApplication;
 pdfjsWebLibs.pdfjsWebApp.PDFViewerApplication.run(config);
}

window.PDFViewerApplication = pdfjsWebLibs.pdfjsWebApp.PDFViewerApplication;
window.PDFViewerApplication.webViewerLoad = webViewerLoad;
