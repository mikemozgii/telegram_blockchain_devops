...
(function (global, factory) {
  ...
  factory(exports, getDependencyFromCache('prosemirror-commands'), getDependencyFromCache('prosemirror-schema-list'), getDependencyFromCache('prosemirror-inputrules'), getDependencyFromCache('prosemirror-state'), getDependencyFromCache('prosemirror-model'), getDependencyFromCache('tiptap-utils'));
