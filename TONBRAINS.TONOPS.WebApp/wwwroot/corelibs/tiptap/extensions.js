...
(function (global, factory) {
    ...
    factory(exports, getDependencyFromCache('tiptap'), getDependencyFromCache('tiptap-commands'), getDependencyFromCache('lowlight'), getDependencyFromCache('prosemirror-view'), getDependencyFromCache('prosemirror-utils'), getDependencyFromCache('prosemirror-state'), getDependencyFromCache('prosemirror-tables'), getDependencyFromCache('tiptap-utils'), getDependencyFromCache('prosemirror-history'));
