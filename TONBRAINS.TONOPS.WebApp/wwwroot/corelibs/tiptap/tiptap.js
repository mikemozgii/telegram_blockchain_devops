   ...
   (function (global, factory) {
    const dependencies = [getDependencyFromCache('prosemirror-state'), getDependencyFromCache('prosemirror-view'),  getDependencyFromCache('prosemirror-model'), getDependencyFromCache('prosemirror-dropcursor'), getDependencyFromCache('prosemirror-gapcursor'), getDependencyFromCache('prosemirror-keymap'), getDependencyFromCache('prosemirror-commands'), getDependencyFromCache('prosemirror-inputrules'), getDependencyFromCache('tiptap-utils'), getDependencyFromCache('tiptap-commands')];
    factory(exports, dependencies[0], dependencies[1], dependencies[2], dependencies[3], dependencies[4], dependencies[5], dependencies[6],dependencies[7], dependencies[8], dependencies[9]);
  
  }(this, function (exports, prosemirrorState, prosemirrorView, prosemirrorModel, prosemirrorDropcursor, prosemirrorGapcursor, prosemirrorKeymap, prosemirrorCommands, prosemirrorInputrules, tiptapUtils, tiptapCommands) { 
    'use strict';
