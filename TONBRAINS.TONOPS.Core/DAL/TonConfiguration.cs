...
namespace TONBRAINS.TONOPS.Core.DAL
{
    public class TonConfiguration
    {
        ...
        public long AdvancedWalletAllocatedBalance { get; set; } = 4999999000;
        // split_depth //0
        public int AdvancedWalletSplitDepth { get; set; } = 0;
        // ticktock //0
        public int AdvancedWalletTickTock { get; set; } = 0;
        // address //1 *  what is AllOnes ?
        public string AdvancedWalletAddress { get; set; } = "1 *";
        // mode: create+setaddr //6
        public int AdvancedWalletCreateSetaddr { get; set; } = 6;


        //SmartContract #4 (elector)
        // balance: 500 grams
        public long ElectorAllocatedBalance { get; set; } = 500;
        // split_depth //0
        public int ElectorSplitDepth { get; set; } = 0;
        // ticktock: tick //2
        public int ElectorTickTock { get; set; } = 2;
        // address: -1:333...333
        public string ElectorAddress { get; set; } = "3 *";
        // mode: create+setaddr //6
        public int ElectorCreateSetaddr { get; set; } = 6;
        ...
        public int MinValidators { get; set; } = 5;
        ...
        //can't take stake back
        public string ElectorConfigAddress { get; set; } = "5 *";
    }
}
